  ...
  import { Stethoscope, HeartPulse, CalendarCheck, User, MessageCircle, Clock, List, Users, Mail, Phone, Shield, Quote } from 'lucide-react';
  import './Landing.css';
      ...
      <div className="landing-page">
                ...
                {userRole && (
                  userRole === 'patient' ? (
                    <Link to="/book-appointment" className="cta-primary">
                      <CalendarCheck className="cta-icon" /> Book Appointment
                    </Link>
                  ) : (
                    <Link to="/doctor-dashboard" className="cta-primary">
                      <User className="cta-icon" /> Check Appointments
                    </Link>
                  )
                )}
              </div>
        ...
        <section className="about-section" id="about-section">
          ...
          <div className="about-content">
            ...
            <div>
              <p>At Healthx, we are committed to providing personalized healthcare services to our patients. Our team of certified specialists is dedicated to ensuring you receive the best care possible.</p>
          ...
          <div className="testimonial-content">
            <div className="testimonial-grid">
              <div className="testimonial-card">
                ...
                <p className="testimonial-text">"Healthx has transformed my healthcare experience. The ability to book appointments instantly is a game-changer."</p>
              ...
              <div className="testimonial-card">
                <div className="testimonial-icon"><Quote /></div>
                <p className="testimonial-text">" Abhishek Sharma says
                  The specialists at Healthx are top-notch. I feel confident in the care I receive.
                  "</p>
                <div className="testimonial-author">
                  <User className="author-icon" />
                  <h3>Jane Smith</h3>
        ...
        <section className="team-section">
          ...
          <div className="team-grid">
            <div className="team-card">
              <div className="icon-wrapper"><Users className="team-icon" /></div>
              <h3>Dr. Sudan</h3>
        ...
        <section className="contact-section">
          ...
          <div className="contact-grid">
            <div className="contact-card">
              <div className="icon-wrapper"><Mail className="contact-icon" /></div>
              <h3>Email</h3>
              <p>info@healthx.com</p>
            </div>
            <div className="contact-card">
              <div className="icon-wrapper"><Phone className="contact-icon" /></div>
              <h3>Phone</h3>
              <p>+977 9848851869</p>
            </div>
          </div>
